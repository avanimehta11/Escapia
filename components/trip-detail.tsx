...
export default function TripDetailClient({ trip }: TripDetailClientProps) {
  ...
  return (
    <div className="container mx-auto px-4 py-8 space-y-8">
      {trip.imageUrl && (
        <div className="w-full h-72 md:h-96 overflow-hidden rounded-xl shapdow-lg relative">
          {" "}
          <Image
            src={trip.imageUrl}
            alt={trip.title}
      ...
      <div className="bg-white p-6 shadow rounded-lg">
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          <TabsList className="mb-6">
            <TabsTrigger value="overview" className="text-lg mr-2">
              Overview
            </TabsTrigger>
            <TabsTrigger value="itinerary" className="text-lg mr-2">
              Itinerary
            </TabsTrigger>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start">
                    <Calendar className="h-6 w-6 mr-3 text-gray" />
                    <div>
              ...
              {trip.locations.length === 0 && (
                <div className="text-left p-4">
                  <Link href={`/trips/${trip.id}/itinerary/new`}>
                    <Button className="bg-gray-600">📍 Add Location</Button>
                  </Link>
                </div>
              )}
            </div>
